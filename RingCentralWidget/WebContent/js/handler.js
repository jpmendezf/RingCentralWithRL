...
var Handler={
		...
		Drive:"ringcentral1.drive",
		Attach:"ringcentral1.attachment"
}
 ...
 */
		...
		Handler.Init = true;
/*
* store orgvariable value
*/
	ZOHO.CRM.CONFIG.getOrgVariable(Handler.Drive).then(function(value){
		drivestatus = value.Success.Content;
	});
	ZOHO.CRM.CONFIG.getOrgVariable(Handler.Attach).then(function(value){
		attachmentstatus = value.Success.Content;
	});
}
